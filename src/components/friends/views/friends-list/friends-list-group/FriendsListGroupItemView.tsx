...
export const FriendsListGroupItemView: FC<{ friend: MessengerFriend, selected: boolean, selectFriend: (userId: number) => void }> = props => {
	...
	const FriendAvatar = friend.online ? (
		<Flex center pointer className="avatar">
			<LayoutAvatarImageView headOnly figure={ friend.id > 0 ? friend.figure : friend.id <= 0 && friend.figure === 'ADM' ? 'ha-3409-1413-70.lg-285-89.ch-3032-1334-109.sh-3016-110.hd-185-1359.ca-3225-110-62.wa-3264-62-62.fa-1206-90.hr-3322-1403' : friend.figure } direction={friend.id > 0 ? 3 : 2} scale={0.5} />
		</Flex> ) : ( <UserProfileIconView userId={friend.id} /> );
